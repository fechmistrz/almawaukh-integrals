...
\begin{problem}[four logarithmic integrals strongly connected with the league of harmonic series]
    \label{valean_1_3}%
...
\begin{problem}[a couple of practical definite integrals expressed in terms of the digamma function]
    \label{valean_1_5}%
...
\begin{problem}[two little tricky classical logarithmic integrals]
    \label{valean_1_7}%
    \begin{align}
...
\begin{problem}[a special trio of integrals]
    \label{valean_1_8}%
    \begin{align}
...
\begin{problem}[the evaluation of a class of logarithmic integrals using a slightly modified result from ,,Table of Integrals, Series and Products'' by I. S. Gradshteyn and I. M. Ryzhik together with a series result elementarily proved by Guy Bastien]
    \label{valean_1_10}%
